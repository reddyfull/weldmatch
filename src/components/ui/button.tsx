  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Hero button - bold orange accent for main CTAs
        hero:
          "bg-accent text-accent-foreground shadow-lg hover:shadow-glow-accent hover:scale-[1.02] active:scale-[0.98] font-bold",
        // Hero outline for secondary hero actions
        heroOutline:
          "border-2 border-white/80 bg-transparent text-white hover:bg-white/10 hover:border-white font-bold",
        // Success variant
        success:
